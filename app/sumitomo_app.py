"""SDB Mock for Sumitomo Rubber — 事業マップ（ホーム）.
...
st.divider()
st.caption(
    "© Sotas — このMockはdiscussion purpose。本番SDB組み込みUXは [[analysis_sdb_integration_design]] 参照"
)
